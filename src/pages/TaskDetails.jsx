        ...
        <div className="column-tasks-container" style={{ gap: '32px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
              <span className="filter-chip active" style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'default', padding: '4px 14px', borderRadius: '20px', textTransform: 'uppercase' }}>
                <Circle size={10} fill="currentColor" /> {task.status}
              </span>
          ...
          <div>
            <div className="flex-between" style={{ marginBottom: '16px' }}>
              <h2 className="category-tag" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Paperclip size={14} /> Attachments <span style={{ color: 'var(--text-muted)', fontWeight: '400' }}>(1)</span>
              </h2>
          ...
          <div>
            ...
            <div className="card" style={{ margin: '0', padding: '40px', textAlign: 'center' }}>
              <div style={{ color: 'var(--text-muted)', opacity: 0.4, marginBottom: '12px', display: 'flex', justifyContent: 'center' }}>
